...
class Mesh extends THREE.Mesh {
  ...
  initialize () {
    ...
    this.getSelectIndex()
    if (_.includes(['cone', 'cylinder', 'chair'], this.app.model) === false) {
